...
const PATHS = {
  ...
  orders: (
    <>
      <path d="M7 3.5h10a1.5 1.5 0 0 1 1.5 1.5v14.2l-3.2-1.8-3.3 1.8-3.3-1.8-3.2 1.8V5A1.5 1.5 0 0 1 7 3.5Z" />
      <path d="M9 8.5h6" />
      <path d="M9 12h6" />
      <path d="M9 15.5h3.5" />
    </>
  ...
  help: (
    <>
      <circle cx="12" cy="12" r="8" />
      <path d="M9.6 9.2a2.5 2.5 0 0 1 4.8.9c0 1.5-2.2 2-2.2 3.4" />
      <path d="M12 17h.01" />
    </>
  ),
  ...
  trash: (
    <>
      <path d="M5 7h14" />
      <path d="M10 7V5h4v2" />
      <path d="M8 7l.8 12.2A1.5 1.5 0 0 0 10.3 20.5h3.4a1.5 1.5 0 0 0 1.5-1.3L16 7" />
    </>
  ),
