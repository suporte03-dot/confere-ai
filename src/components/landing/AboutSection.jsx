    ...
    <section id="sobre" className="lp-about">
      <div className="lp-container lp-about__grid">
        <div className="lp-about__content">
          ...
          <h2>A marca do agro brasileiro</h2>
          <p className="lp-about__lead">
            Terra & Estilo nasce da união entre elegância, origem e autenticidade. Uma moda
        ...
        <div className="lp-about__visual">
          <img
            ...
            alt="Painel de identidade visual Terra & Estilo"
            loading="lazy"
          />
        </div>
      </div>
